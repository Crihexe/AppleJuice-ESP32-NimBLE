// ESP32 Arduino implementation of Apple Juice with NimBLE
// Author: Ronald Stoner - Fork and edit by Crihexe
// Github: https://github.com/ronaldstoner / https://github.com/Crihexe

// Based on the previous work of chipik / _hexway / ECTO-1A & SAY-10 / Ronald Stoner
...
int deviceType = 3; // 1 for Airpods, 2 for Airpods Pro, 3 for Airpods Max, 4 for...
int advType = 2; 
  // 0 - ADV_TYPE_IND
...
void setup() {
  ...
  pAdvertising->setAdvertisementType(advType);
}
...
void loop() {
  ...
  delay(20);
  pAdvertising->stop();
  if(++deviceType > 26) deviceType = 1; // sending every device request
}
